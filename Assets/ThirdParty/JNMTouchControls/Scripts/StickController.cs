...
public class StickController : MonoBehaviour
{
    ...
    {
        Debug.Log("HandleTouchInput is called.");
    ...
    protected virtual void HandleInput(Vector3 input)
    {
        ...
        {
            var args = new StickEventArgs(new Vector2(normDiff.x, 0f));
            StickChanged(this, args);
            Debug.Log("Stick Position: " + args.Position);
        }
    ...
    {
        StickEventArgs args = new StickEventArgs(Vector2.zero);
        StickChanged?.Invoke(this, args);
        Debug.Log("Stick Position from GetStickPosition: " + args.Position);
